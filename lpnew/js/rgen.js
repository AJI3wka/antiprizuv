...
; (function () {
	...
	********************************************/
	...
	rgen.global_validation = {
		...
		subscribe_successMsg: "Вы подписались. Мы проинформируем Вас сразу как закончим.",
		form_successMsg: "Спасибо за Ваше обращение! Наши специалисты скоро с Вами свяжутся. ",

		successMsg: "",
		errorMsg: "Oops! Кажется, что-то пошло не так. Пожалуйста, попытайтесь позднее."
	}
